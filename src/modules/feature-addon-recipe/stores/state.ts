...
export interface AddonRecipeState {
    ...
    updateAddonRecipe: {
        state: ViewState<ApiResponse<null>, string>;
        updateAddonRecipe: (id: string | number, data: BulkCreateAddonRecipeDTOType) => Promise<void>;
    };
    ...
    modal: {
        ...
        onOpen: (mode: "create" | "edit" | "delete", data?: AddonRecipe | null, addonId?: string | number) => void;
        onClose: () => void;
    };
