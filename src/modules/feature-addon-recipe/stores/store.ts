...
export const useAddonRecipeStore = create<AddonRecipeState>((set) => ({
  ...
  addonRecipe: {
    ...
    getAddonRecipeByAddonId: async (addonId: string | number) => {
      ...
      try {
        const addonRecipe =
          await addonRecipeApi.getAddonRecipeByAddonId(addonId);
        if (!addonRecipe?.data) {
  ...
  deleteAddonRecipe: {
    ...
    deleteAddonRecipesByAddonId: async (addonId: string | number) => {
      ...
      try {
        const response =
          await addonRecipeApi.deleteAddonRecipesByAddonId(addonId);
        if (!response) {
