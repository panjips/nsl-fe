        ...
        getAllProductRecipes: async () => {
            ...
            try {
                ...
                set((state) => ({
                    productRecipes: {
                        ...state.productRecipes,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch product recipes"),
                    },
                }));
            }
        },
        ...
        getProductRecipeByProductId: async (
            ...
            try {
                ...
                set((state) => ({
                    productRecipe: {
                        ...state.productRecipe,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch product recipe"),
                    },
                }));
            }
        },
        ...
        createProductRecipe: async (data: BulkCreateProductRecipeDTOType) => {
            ...
            try {
                ...
                set((state) => ({
                    createProductRecipe: {
                        ...state.createProductRecipe,
                        state: errorState(error instanceof Error ? error.message : "Failed to create product recipe"),
                    },
                }));
            }
        },
        ...
        deleteProductRecipesByProductId: async (productId: string | number) => {
            ...
            try {
                ...
                set((state) => ({
                    deleteProductRecipe: {
                        ...state.deleteProductRecipe,
                        state: errorState(error instanceof Error ? error.message : "Failed to delete product recipe"),
                    },
                }));
            }
        },
        ...
        updateProductRecipe: async (id: string | number, data) => {
            ...
            try {
                ...
                set((state) => ({
                    updateProductRecipe: {
                        ...state.updateProductRecipe,
                        state: errorState(error instanceof Error ? error.message : "Failed to update product recipe"),
                    },
                }));
            }
        },
