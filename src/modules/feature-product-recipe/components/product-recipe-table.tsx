import {
  productRecipeColumnHelper,
  setupProductRecipeColumns,
} from "./product-recipe-column";
...
export const ProductRecipeTable = () => {
  ...
  return (
    <>
      ...
      <ProductRecipeMutationModal
        productId={modal.data?.id ?? modal.productId ?? undefined}
      />
