        ...
        getAllCateringPackages: async () => {
            ...
            try {
                ...
                set((state) => ({
                    cateringPackages: {
                        ...state.cateringPackages,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch catering packages"),
                    },
                }));
            }
        },
        ...
        getCateringPackage: async (id) => {
            ...
            try {
                ...
                set((state) => ({
                    cateringPackage: {
                        ...state.cateringPackage,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch catering package"),
                    },
                }));
            }
        },
        ...
        updateCateringPackage: async (id, data) => {
            ...
            try {
                ...
                set((state) => ({
                    updateCateringPackage: {
                        ...state.updateCateringPackage,
                        state: errorState(error instanceof Error ? error.message : "Failed to update catering package"),
                    },
                }));
            }
        },
        ...
        createCateringPackage: async (data: CreateCateringPackageDTOType) => {
            ...
            try {
                ...
                set((state) => ({
                    createCateringPackage: {
                        ...state.createCateringPackage,
                        state: errorState(error instanceof Error ? error.message : "Failed to create catering package"),
                    },
                }));
            }
        },
        ...
        deleteCateringPackage: async (id) => {
            ...
            try {
                ...
                set((state) => ({
                    deleteCateringPackage: {
                        ...state.deleteCateringPackage,
                        state: errorState(error instanceof Error ? error.message : "Failed to delete catering package"),
                    },
                }));
            }
        },
