...
export const dashboardColumnHelper = createZodColumnHelper(TableDashboardSchema);
...
export const setupDashboardColumns = ({ columnHelper, onEdit, onDelete }: SetupDashboardColumnsProps) => {
    return [
        // Header column
