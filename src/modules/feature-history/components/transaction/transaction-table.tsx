...
import { transactionColumnHelper, setupTransactionColumns } from "./transaction-column";
...
export const AllOrderTable = () => {
    const { data, isLoading, setSearchTerm, searchTerm, setStatusFilter, statusFilter } = useTransaction();
    ...
    const columns = useMemo(() => {
        return setupTransactionColumns({
            columnHelper: transactionColumnHelper,
