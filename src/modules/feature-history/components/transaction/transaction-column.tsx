...
export const transactionColumnHelper = createTypedColumnHelper<OnlineOrder>();

export interface SetupTransactionColumnsProps {
    columnHelper: ColumnHelper<OnlineOrder>;
    onDetail?: (id: string | number, data?: OnlineOrder) => void;
}

export const setupTransactionColumns = ({ columnHelper, onDetail }: SetupTransactionColumnsProps) => {
    return [
        ...
        columnHelper.accessor("order_type", {
            ...
            cell: ({ row }) => <div>{row.original.order_type}</div>,
        }),
