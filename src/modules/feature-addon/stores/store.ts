        ...
        getAllAddons: async () => {
            ...
            try {
                ...
                set((state) => ({
                    addons: {
                        ...state.addons,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch addons"),
                    },
                }));
            }
        },
        ...
        getAddon: async (id: string | number) => {
            ...
            try {
                ...
                set((state) => ({
                    addon: {
                        ...state.addon,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch addon"),
                    },
                }));
            }
        },
        ...
        updateAddon: async (id: string | number, data) => {
            ...
            try {
                ...
                set((state) => ({
                    updateAddon: {
                        ...state.updateAddon,
                        state: errorState(error instanceof Error ? error.message : "Failed to update addon"),
                    },
                }));
            }
        },
        ...
        createAddon: async (data) => {
            ...
            try {
                ...
                set((state) => ({
                    createAddon: {
                        ...state.createAddon,
                        state: errorState(error instanceof Error ? error.message : "Failed to create addon"),
                    },
                }));
            }
        },
        ...
        deleteAddon: async (id: string | number) => {
            ...
            try {
                ...
                set((state) => ({
                    deleteAddon: {
                        ...state.deleteAddon,
                        state: errorState(error instanceof Error ? error.message : "Failed to delete addon"),
                    },
                }));
            }
        },
