        ...
        getAllPurchases: async () => {
            ...
            try {
                ...
                set((state) => ({
                    purchases: {
                        ...state.purchases,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch purchases"),
                    },
                }));
            }
        },
        ...
        getPurchase: async (id: string | number) => {
            ...
            try {
                ...
                set((state) => ({
                    purchase: {
                        ...state.purchase,
                        state: errorState(error instanceof Error ? error.message : "Failed to fetch purchase"),
                    },
                }));
            }
        },
        ...
        updatePurchase: async (id: string | number, data) => {
            ...
            try {
                ...
                set((state) => ({
                    updatePurchase: {
                        ...state.updatePurchase,
                        state: errorState(error instanceof Error ? error.message : "Failed to update purchase"),
                    },
                }));
            }
        },
        ...
        createPurchase: async (data) => {
            ...
            try {
                ...
                set((state) => ({
                    createPurchase: {
                        ...state.createPurchase,
                        state: errorState(error instanceof Error ? error.message : "Failed to create purchase"),
                    },
                }));
            }
        },
        ...
        deletePurchase: async (id: string | number) => {
            ...
            try {
                ...
                set((state) => ({
                    deletePurchase: {
                        ...state.deletePurchase,
                        state: errorState(error instanceof Error ? error.message : "Failed to delete purchase"),
                    },
                }));
            }
        },
