...
export interface PurchaseState {
    ...
    updatePurchase: {
        ...
        updatePurchase: (id: string | number, data: UpdatePurchaseDTOType) => Promise<void>;
    };
    createPurchase: {
        state: ViewState<ApiResponse<null>, string>;
    ...
    modal: {
        ...
        onOpen: (mode: "create" | "edit" | "delete", data?: PurchaseWithInventory | null, id?: string | number) => void;
        onClose: () => void;
    };
    resetModal: () => void;
