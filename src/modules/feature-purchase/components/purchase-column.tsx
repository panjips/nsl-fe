...
export const purchaseColumnHelper =
  createTypedColumnHelper<PurchaseWithInventory>();
...
export const setupPurchaseColumns = ({
  columnHelper,
  onEdit,
  onDelete,
}: SetupPurchaseColumnsProps) => {
  return [
    ...
    columnHelper.accessor("purchase_date", {
      ...
      cell: ({ row }) => {
        return (
          <div>
            {format(new Date(row.original.purchase_date), "dd MMM yyyy")}
          </div>
        );
      },
    }),
