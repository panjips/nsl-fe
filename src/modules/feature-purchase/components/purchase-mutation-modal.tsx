...
export const PurchaseMutationModal = ({
    ...
    const isEdit = !!id;
    const { data: inventories, isLoading: isLoadingInventories } = useListInventory();
    ...
    const { isOpen: isOpenCreate, handleSubmitCreate, isLoading: isLoadingCreate, onOpenChange } = useCreatePurchase();

    const { isOpen: isOpenEdit, data, handleSubmitEdit, isLoading: isLoadingEdit } = useEditPurchase();
