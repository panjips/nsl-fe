...
export function useResetPassword() {
  ...
  const { resetPassword, resetPasswordState, resetResetPasswordState } =
    useAuthStore();
  ...
  useEffect(() => {
    ...
    if (resetPasswordState.state === "success") {
      ...
      toast.success(
        resetPasswordState.data?.message || "Password successfully reset"
      );
    }
  ...
  return {
    ...
    errorMessage:
      resetPasswordState.state === "error" ? resetPasswordState.error : null,
    countdown,
    hasToken: !!token,
  };
}
