...
export const CategoryMutationModal = ({
    ...
    const { isOpen: isOpenCreate, handleSubmitCreate, isLoading: isLoadingCreate } = useCreateCategory();

    const { isOpen: isOpenEdit, onOpenChange, data, handleSubmitEdit, isLoading: isLoadingEdit } = useEditCategory();
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type="text" placeholder="Category Name" {...field} className="input" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
