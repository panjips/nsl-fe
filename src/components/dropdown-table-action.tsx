...
export const TableActions: React.FC<TableActionsProps> = ({
    ...
    return (
        <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
                {onDetail && <DropdownMenuItem onClick={(e) => handleAction(onDetail, e)}>Detail</DropdownMenuItem>}
                {onEdit && <DropdownMenuItem onClick={(e) => handleAction(onEdit, e)}>Edit</DropdownMenuItem>}
                {onDelete && (
                    <DropdownMenuItem variant="destructive" onClick={(e) => handleAction(onDelete, e)}>
                        Delete
                    </DropdownMenuItem>
                )}
